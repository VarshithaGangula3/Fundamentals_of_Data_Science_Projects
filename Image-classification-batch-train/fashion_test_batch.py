...
model.load_state_dict(torch.load("weights_batches.pt"))
...
# Get the accuracy
accuracy = accuracy_score(y_test_np, predictions) ## Your code here
print(f"Accuracy on test data: {accuracy * 100.0:>2.2f}%")

# Make a confusion matrix
cm = confusion_matrix(y_test_np, predictions) ## Your code here
...
## Your code here
fig.savefig("confusion_batches.png")
print("Wrote confusion_batches.png")
